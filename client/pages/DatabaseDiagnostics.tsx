...
const DatabaseDiagnostics: React.FC = () => {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'success':
        return <Badge className="bg-green-100 text-green-700 border-green-200">نجح</Badge>;
      case 'error':
        return <Badge className="bg-red-100 text-red-700 border-red-200">فشل</Badge>;
      case 'warning':
        return <Badge className="bg-yellow-100 text-yellow-700 border-yellow-200">تحذير</Badge>;
      default:
        return <Badge className="bg-gray-100 text-gray-700 border-gray-200">غير معروف</Badge>;
    }
  };
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        {errorCount > 0 && (
          <Alert>
            ...
            <AlertDescription>
              <strong>إصلاح مطلوب:</strong> توجد أخطاء في قاعدة البيانات. تأكد من:
